...
Essas relações deverão ser modeladas pelos alunos utilizando <> e <> quando apropriado.
...
Criar um arquivo NOMEALUNO_RA.md contendo toda a modelagem solicitada na avaliação, considerando o template AVALIACAO.md que está em /docs.
Organizar o conteúdo de maneira clara e bem estruturada.
Enviar o arquivo por meio de Pull Request (PR) no repositório da disciplina.
Avaliação
...
Diagramas de atividade para cada caso de uso.# simulacao1
